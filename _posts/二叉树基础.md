...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/96.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/97.png)
<!--more-->

除此之外，关于树，还有三个比较相似的概念：`高度`（Height）、`深度`（Depth）、`层`（Level）。它们的定义是这样的：
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/98.png)

这三个概念的定义比较容易混淆，描述起来也比较空洞。我举个例子说明一下，你一看应该就能明白：
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/99.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/100.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/101.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/102.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/103.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/104.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/105.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/106.png)

### 二叉查找树的查找操作
首先，我们看如何在二叉查找树中查找一个节点。我们先取根节点，如果它等于我们要查找的数据，那就返回。如果要查找的数据比根节点的值小，那就在左子树中递归查找；如果要查找的数据比根节点的值大，那就在右子树中递归查找：
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/107.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/108.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/109.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/110.png)
    当要查找数据的时候，遇到值相同的节点，我们并不停止查找操作，而是**继续在右子树中查找，直到遇到叶子节点，才停止**。这样就可以把键值等于要查找值的所有节点都找出来：
    ![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/111.png)
    对于删除操作，我们也需要先查找到每个要删除的节点，然后再**按前面讲的删除操作的方法，依次删除**：
    ![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/112.png)
...
![](https://raw.githubusercontent.com/was48i/mPOST/master/CLRS/geek/113.png)
