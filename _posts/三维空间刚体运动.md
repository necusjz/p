...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_1.jpeg)
...
### 坐标系间的欧氏变换
转换关系由一个矩阵 T 来描述：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_2.jpeg)
相机运动是一个刚体运动，这种变换称为**欧氏变换**，对于同一个向量 a ，该向量并没有随着坐标系的旋转而发生运动。
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_3.jpeg)
矩阵 R 描述了旋转本身，因此又称为**旋转矩阵**。
旋转矩阵可以描述相机的旋转，是行列式为 1 的正交矩阵，集合定义如下：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_4.jpeg)
...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_5.jpeg)
...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_6.jpeg)
与 SO(3) 一样，求解该矩阵的逆表示一个反向的变换:
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_20.jpeg)
...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_7.jpeg)
符号 ^ 是向量的反对称转换符。
#### 旋转矩阵到旋转向量的转换
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_8.jpeg)
...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_9.jpeg)
其中，I，j，k 为四元数的三个虚部。这三个虚部满足以下关系式：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_10.jpeg)
有时人们也用一个标量和一个向量来表达四元数：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_11.jpeg)
...
### 四元数与旋转向量的转换
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_12.jpeg)
反之，亦可从单位四元数中计算出对应旋转轴与夹角：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_13.jpeg)
### 四元数与旋转矩阵的转换
现在看来把四元数转换为矩阵的最直观方法，是先把四元数 **q** 转换为轴角 θ 和 **n**，然后再根据罗德里格斯公式转换为矩阵。不过那样要计算一个 arccos 函数，代价较大。
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_14.jpeg)
反之，由旋转矩阵到四元数的转换如下：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_15.jpeg)
...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_16.jpeg)
### 仿射变换
与欧氏变换不同的是，仿射变换只要求 **A** 是一个可逆矩阵，而不必是正交矩阵。经过仿射变换之后，立方体不再是方的了，但是各个面仍然是平行四边形，其矩阵形式如下：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_17.jpeg)
### 射影变换
...
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_18.jpeg)
下表总结了几种变换的性质。注意在`不变性质`中，从上到下是有包含关系的：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_19.jpeg)
## 实践：Eigen 几何模块
我们将在 Eigen 中使用四元数、欧拉角和旋转矩阵，演示它们之间的变换方式。每种类型都有单精度和双精度两种数据类型（不能由编译器自动转换），下面以双精度为例，把最后的 d 改成 f，即得到单精度的数据结构：
![](https://raw.githubusercontent.com/umarellyh/mPOST/master/SLAM/3_21.jpeg)
## 可视化演示
